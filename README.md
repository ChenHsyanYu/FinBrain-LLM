...
## wandb_latest 
所有 wandb 上的訓練，已用 html 檔案包裹，瀏覽器點開就可以直接查看 wandb 上的所有資料

* [fin_brain_reset](./Training/wandb_latest/fin_brain_reset/)： 容器被刪除後重新訓練的資料
* [gin_brain_taide](./Training//wandb_latest/fin_brain_taide/)： 原始的訓練資料，包含 exp10、exp17等
